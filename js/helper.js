...
var HTMLheaderRole = '<span class="darkBlue">%data%</span><hr/>';

var HTMLcontactGeneric = '<li class="flex-item"><span class="darkBlue">%contact%</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<h3 class="darkBlue">Skills at a Glance:</h3><ul id="skills" class="flex-box flex-direction-col"></ul>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    locations.push(resumeBuilder.bio.contacts.location2);
